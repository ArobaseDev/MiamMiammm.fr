import type { History, Location, Path, To } from ".pnpm/@remix-run+router@1.17.1/node_modules/@remix-run/router/dist/history";
import { Action as HistoryAction } from ".pnpm/@remix-run+router@1.17.1/node_modules/@remix-run/router/dist/history";
import type { AgnosticDataRouteMatch, AgnosticDataRouteObject, AgnosticRouteObject, DataStrategyFunction, DeferredData, DetectErrorBoundaryFunction, FormEncType, HTMLFormMethod, MapRoutePropertiesFunction, RouteData, Submission, UIMatch, AgnosticPatchRoutesOnMissFunction } from ".pnpm/@remix-run+router@1.17.1/node_modules/@remix-run/router/dist/utils";
/**
