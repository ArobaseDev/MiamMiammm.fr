...
import type { AgnosticIndexRouteObject, AgnosticNonIndexRouteObject, AgnosticRouteMatch, History, LazyRouteFunction, Location, Action as NavigationType, RelativeRoutingType, Router, StaticHandlerContext, To, TrackedPromise } from ".pnpm/@remix-run+router@1.17.1/node_modules/@remix-run/router";
...
export declare const DataRouterStateContext: React.Context<import(".pnpm/@remix-run+router@1.17.1/node_modules/@remix-run/router").RouterState | null>;
