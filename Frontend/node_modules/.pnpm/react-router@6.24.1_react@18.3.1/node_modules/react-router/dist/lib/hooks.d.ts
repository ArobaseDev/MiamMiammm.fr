...
import type { Blocker, BlockerFunction, Location, ParamParseKey, Params, Path, PathMatch, PathPattern, RelativeRoutingType, Router as RemixRouter, RevalidationState, To, UIMatch } from ".pnpm/@remix-run+router@1.17.1/node_modules/@remix-run/router";
import { Action as NavigationType } from ".pnpm/@remix-run+router@1.17.1/node_modules/@remix-run/router";
import type { NavigateOptions, RouteContextObject, RouteMatch, RouteObject } from ".pnpm/react-router@6.24.1_react@18.3.1/node_modules/react-router/dist/lib/context";
/**
 ...
 */
export declare function useNavigation(): import(".pnpm/@remix-run+router@1.17.1/node_modules/@remix-run/router").Navigation;
/**
