import type { InitialEntry, LazyRouteFunction, Location, RelativeRoutingType, Router as RemixRouter, To, TrackedPromise } from ".pnpm/@remix-run+router@1.17.1/node_modules/@remix-run/router";
import { Action as NavigationType } from ".pnpm/@remix-run+router@1.17.1/node_modules/@remix-run/router";
import * as React from "react";
import type { IndexRouteObject, Navigator, NonIndexRouteObject, RouteMatch, RouteObject } from ".pnpm/react-router@6.24.1_react@18.3.1/node_modules/react-router/dist/lib/context";
