        ...
        <nav className="bg-white border-gray-200 px-4 lg:px-6 py-6 dark:bg-gray-800">
          <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <NavLink to="/favorites-recipes" className="flex items-center">
              ...
              <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white"> Mes recettes favorites </span><span className="text-red-500 mx-2 text-3xl">({favoritesNumber})</span>
            </NavLink>
